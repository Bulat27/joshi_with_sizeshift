...
class Config:
    ...
    deepset_alternate_training: Optional[DeepSetAlternateTraining] = field(default_factory=lambda: DeepSetAlternateTraining(False, True, 50))
    ...
    batch_norm: BatchNormConfig = field(default_factory=lambda: BatchNormConfig(True, False))
